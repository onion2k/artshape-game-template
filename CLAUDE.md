...
rules in `~/.claude/CLAUDE.md` apply too. Everything in square brackets is
the template's, to be replaced in the first hour of a new game.
...
- [the game's own: its rooms, its machines, whatever else a new thing meets]
